...
datos_producto = [
    {"codigo": "001", "nombre": "x", "precio": 1.00},
    {"codigo": "002", "nombre": "x", "precio": 2.00},
    {"codigo": "003", "nombre": "x", "precio": 3.00},
    {"codigo": "004", "nombre": "x", "precio": 4.00},
    {"codigo": "005", "nombre": "x", "precio": 5.00},
    {"codigo": "006", "nombre": "x", "precio": 6.00},
    {"codigo": "007", "nombre": "x", "precio": 7.00}
]
...
def lista_ventas():
    if len(ventas) == 0:
        ...
        for venta in ventas:
            ...
            print("Empresa: xxxxxxxx")
            print("Dirección: xxxxxxxxx")
            ...
            print("IGV:", igv)
            print("Total (con IGV):", total_con_igv)
            print("----------------------------------")
